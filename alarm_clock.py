...
def alarmclock(alarmtime): 
    while True:
        ...
        if time_now==alarmtime:
            ...
            # print("wake up!")
            mixer.init()
            mixer.music.load('/home/kirtee/Downloads/alarm ringtone.mpga')
            mixer.music.play()
            break
hrs=StringVar()
mins=StringVar()
...
clockimg=PhotoImage(file="/home/kirtee/Desktop/resume/imagesmegha.png")
...
fg="white",font = ('arial', 20, 'bold')).grid(row=4,column=1,columnspan=5)
